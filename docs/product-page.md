...
- **The basket pop-up shows the basket's own summary**, which still has the old site's styling inside the new pop-up. Restyling it means changing `AddToCartComponent.cshtml`, which other pages use too.
